...
/**
 * 
 * This is a wrapper class that overrides the
 * {@link #bindExternalFunction(String, ExternalFunction)} method so that we can
 * bind external functions without unbinding them first.
 * 
 * @author Joe Dai
 *
 */
